...
| **Hex Color Support**                    | Fully supports hex colors (`#RRGGBB`).                                                | Yes, supports hex via markup (e.g. `[color=#FF5733]Text[/]`).             | Not supported. Limited to predefined colors.                            | Not supported. Only basic named colors.                                 | Does not support color by itself.                                        |
